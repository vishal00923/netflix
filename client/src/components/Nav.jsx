        ...
        >
          <select
            className='bg-black text-white px-1 py-[2px]
             ...
             font-normal tablet:py-[4.5px] tablet:text-[0.938rem] laptop:py-[5px] 
          ...
          <button
            ...
            className='w-[65px] bg-red-600 text-white tracking-tighter 
            inline-block px-2 py-1 text-[0.875rem] rounded-sm font-normal 
            tablet:px-3 tablet:py-1.5 tablet:text-[0.9rem] tablet:w-[80px] 
            laptop:text-[1rem] laptop:w-[90px] transition-all hover:bg-red-500'
          >
            Sign In
          </button>
        </div>
