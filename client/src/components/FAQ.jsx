    ...
    <section className='w-full h-full border-b-8 border-b-[#202020]'>
      ...
      >
        <div className='px-5 laptop:pl-24'>
          <h2
            className='text-center leading-[1.12] text-white text-[1.5rem] 
          ...
          <div
            className='pt-2 max-w-[420px] mx-auto tablet:pt-3 tablet:max-w-[520px] 
          laptop:pt-4 laptop:max-w-[620px] desktop:pt-5 desktop:max-w-[720px]'
          >
            <p
