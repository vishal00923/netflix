...
export default function StoryDownload() {
  return (
    <section className='w-full h-full border-b-8 border-b-[#202020]'>
      ...
      laptop:flex laptop:flex-row-reverse laptop:justify-between laptop:items-center'
      >
        <div
        ...
        >
          <h2
            className='leading-[1.12] text-white text-center text-[1.65rem]
           tablet:text-[2.5rem] laptop:text-[3.25rem] laptop:text-left desktop:max-w-[600px]'
          >
            Download your shows to watch offline.
          </h2>
          <p
            className='text-white max-w-[455px] text-center text-[1rem]
        ...
        <div className='py-1 tablet:py-2 laptop:py-3.5 desktop:py-4'>
          ...
          >
            ...
            <div
              className='w-[70%] h-[70px] border-2 border-[#595959] bg-black/90
             absolute bottom-[5%] left-[15%] rounded-xl tablet:h-[80px] tablet:bottom-[6%]
              laptop:h-[88px] desktop:h-[100px] desktop:bottom-[6.5%]'
            >
              <div className='px-3 py-2 flex justify-between items-center tablet:py-2.5 laptop:pt-3'>
                <div className='flex items-center space-x-4'>
                  ...
                  <div className='flex flex-col justify-center -space-y-0.5'>
                    <p
                      className='text-white font-semibold text-[0.92rem]
                     tablet:text-[0.95rem] laptop:text-[0.98rem] desktop:text-[1rem]'
                    >
                      Stranger Things
                    </p>
                    <span
                      className='text-[#2020ff] text-[0.82rem]
                     font-semibold tablet:text-[0.84rem] laptop:text-[0.9rem] desktop:text-[0.95rem]'
                    >
                      Downloading...
                    </span>
                  </div>
